  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
      ...
      <div className="flex gap-2">
        <button className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-900 py-2 px-4 rounded transition">
          View
        </button>
        <button className="flex-1 bg-red-100 hover:bg-red-200 text-red-700 py-2 px-4 rounded transition">
          Delete
        </button>
      </div>
    </div>
